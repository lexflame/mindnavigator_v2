...
class Database(DatabaseSchemaMixin, DatabaseTasksMixin, DatabaseProjectsMixin, DatabaseMapsMixin, DatabaseNotesIdeasMixin, DatabaseObjectsCharactersMixin, DatabaseCollectionsMixin, DatabasePurchasesMixin, DatabaseSettingsCloudMixin, DatabaseCoreMixin):
    """???????????????? ?? ?????????????????? ?????????? ???????????? ????????????????????."""
