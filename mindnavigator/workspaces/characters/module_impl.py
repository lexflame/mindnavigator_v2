"""Workspace for character cards and cross-entity links."""
...
from mindnavigator.storage import CHARACTER_ENTITY_KINDS, CharacterData, CharacterLinkData, get_database
