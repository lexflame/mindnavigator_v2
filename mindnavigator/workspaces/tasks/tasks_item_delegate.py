...
class TasksItemDelegate(QStyledItemDelegate):
    ...
    PROJECT_TYPE_BRACKET_W = 12
    PROJECT_TYPE_BRACKET_H = 20
    ...
    def _project_type_bracket_rect(project_rect: QRect) -> QRect:
        return QRect(
            project_rect.left(),
            project_rect.center().y() - TasksItemDelegate.PROJECT_TYPE_BRACKET_H // 2,
            TasksItemDelegate.PROJECT_TYPE_BRACKET_W,
            TasksItemDelegate.PROJECT_TYPE_BRACKET_H,
        )
    ...
    def _draw_project_type_switch_button(self, painter: QPainter, switch_rect: QRect, bracket_rect: QRect, color: QColor) -> None:
        ...
        arrow_center = bracket_rect.center()
        arrow = QPolygon(
            [
                QPoint(arrow_center.x() - 4, arrow_center.y() - 2),
                QPoint(arrow_center.x() + 4, arrow_center.y() - 2),
                QPoint(arrow_center.x(), arrow_center.y() + 3),
            ]
        )
