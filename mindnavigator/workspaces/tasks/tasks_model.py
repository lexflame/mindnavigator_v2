...
class TasksModel(QAbstractListModel):
    ...
    def _row_from_task_data(task: TaskData) -> TaskRow:
        return TaskRow(
            ...
            project_task_type_value=task.project_task_type_value,
            project_task_type_color=task.project_task_type_color,
            project_task_type_theme=task.project_task_type_theme,
            project_task_type_priority=task.project_task_type_priority,
            project_task_type_importance=task.project_task_type_importance,
            project_task_type_is_plan_task=task.project_task_type_is_plan_task,
            project_task_type_concept_board_id=task.project_task_type_concept_board_id,
