...
Measure `fetch_tasks`, global search, `TasksModel.refresh()`, lazy attachment summaries, expanded task delegate size hints, and task/project form construction in offscreen Qt mode:
